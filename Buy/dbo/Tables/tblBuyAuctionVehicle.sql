CREATE TABLE [dbo].[tblBuyAuctionVehicle] (
    ...
    CONSTRAINT [fk_tblBuyAuctionVehicle_tblBuyAuctionType_1] FOREIGN KEY ([BuyAuctionTypeID]) REFERENCES [mybuys].[tblBuyAuctionType] ([BuyAuctionTypeID])
);
...
CREATE NONCLUSTERED INDEX [idx_tblBuyAuctionVehicle_BuyVehicleID_BuyAuctionListTypeID]
    ...
    INCLUDE([BuyAuctionVehicleID], [SaleDate], [Lane], [Run], [Odometer], [SellerName], [VehicleLink], [CRLink], [CRScore], [PreSaleAnnouncement], [PriceCap], [IsPreviousDTVehicle], [IsDTInspectionRequested], [IsDecommissioned], [IsDecommissionedDateTime], [ProxyBidAmount], [KBBMultiplier], [KBBDTAdjustmentValue], [MMRValue], [BuyStrategyID], [Images], [IsAccuCheckIssue], [IsAccuCheckIssueDateTime], [IsBuyerAppVehicle]) WITH (FILLFACTOR = 90);
