...
GO
CREATE NONCLUSTERED INDEX [idx_tblBuyDestinationPriorityStage_AuctionName_Includes]
    ON [dbo].[tblBuyDestinationPriorityStage]([AuctionName] ASC)
    INCLUDE([VIN], [SaleDate], [CRLLT], [LocationPriority], [IDNumber]) WITH (FILLFACTOR = 90);
