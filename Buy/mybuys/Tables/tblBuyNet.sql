CREATE TABLE [mybuys].[tblBuyNet] (
    ...
    CONSTRAINT [FK_tblBuyNet_BuyAuctionGuaranteeType] FOREIGN KEY ([BuyAuctionGuaranteeTypeID]) REFERENCES [mybuys].[tblBuyAuctionGuaranteeType] ([BuyAuctionGuaranteeTypeID])
);
