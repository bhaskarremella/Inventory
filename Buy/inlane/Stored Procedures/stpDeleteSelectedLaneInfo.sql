...
CREATE PROCEDURE [inlane].[stpDeleteSelectedLaneInfo]
...
Description : Delete IsLaneSelected and LaneSelectedBy fields 

EXEC inlane.stpDeleteSelectedLaneInfo
------------------------------------------------------------------------------------------
*/
AS
BEGIN;
...
ELSE
   ...
   SAVE TRANSACTION stpDeleteSelectedLaneInfo;
...
BEGIN CATCH
    ...
    ELSE
       ...
       IF @XactState <> -1
            ROLLBACK TRANSACTION stpDeleteSelectedLaneInfo;
