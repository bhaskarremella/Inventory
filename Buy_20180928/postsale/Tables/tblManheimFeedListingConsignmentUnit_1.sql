...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingConsignmentUnit_ManheimFeedListingConsignmentID]
    ON [postsale].[tblManheimFeedListingConsignmentUnit]([ManheimFeedListingConsignmentID] ASC) WITH (FILLFACTOR = 90);
