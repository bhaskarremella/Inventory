...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingOfferingSaleKey_ManheimFeedListingOfferingID]
    ON [postsale].[tblManheimFeedListingOfferingSaleKey]([ManheimFeedListingOfferingID] ASC) WITH (FILLFACTOR = 90);
