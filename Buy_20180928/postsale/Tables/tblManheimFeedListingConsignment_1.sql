...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingConsignment_ManheimFeedListingID]
    ON [postsale].[tblManheimFeedListingConsignment]([ManheimFeedListingID] ASC) WITH (FILLFACTOR = 90);
