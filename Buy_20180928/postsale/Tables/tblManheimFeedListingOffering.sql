...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingOffering_ManheimFeedListingID]
    ON [postsale].[tblManheimFeedListingOffering]([ManheimFeedListingID] ASC) WITH (FILLFACTOR = 90);
