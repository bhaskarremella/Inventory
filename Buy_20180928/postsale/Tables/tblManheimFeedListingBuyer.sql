...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingBuyer_ManheimFeedListingID]
    ON [postsale].[tblManheimFeedListingBuyer]([ManheimFeedListingID] ASC) WITH (FILLFACTOR = 90);
