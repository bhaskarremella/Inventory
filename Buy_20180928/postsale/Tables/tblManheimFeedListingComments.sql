...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingComments_ManheimFeedListingID]
    ON [postsale].[tblManheimFeedListingComments]([ManheimFeedListingID] ASC) WITH (FILLFACTOR = 90);
