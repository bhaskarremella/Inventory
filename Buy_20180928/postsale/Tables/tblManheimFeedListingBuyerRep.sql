...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingBuyerRep_ManheimFeedListingBuyerID]
    ON [postsale].[tblManheimFeedListingBuyerRep]([ManheimFeedListingBuyerID] ASC) WITH (FILLFACTOR = 90);
