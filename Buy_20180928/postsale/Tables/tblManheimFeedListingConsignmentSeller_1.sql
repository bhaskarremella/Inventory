...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingConsignmentSeller_ManheimFeedListingConsignmentID]
    ON [postsale].[tblManheimFeedListingConsignmentSeller]([ManheimFeedListingConsignmentID] ASC) WITH (FILLFACTOR = 90);
