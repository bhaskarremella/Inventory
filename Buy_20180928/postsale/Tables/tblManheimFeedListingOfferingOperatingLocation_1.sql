...
GO
CREATE NONCLUSTERED INDEX [idx_tblManheimFeedListingOfferingOperatingLocation_ManheimFeedListingOfferingID]
    ON [postsale].[tblManheimFeedListingOfferingOperatingLocation]([ManheimFeedListingOfferingID] ASC) WITH (FILLFACTOR = 90);
