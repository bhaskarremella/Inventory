...
Updated By  : Gwendolyn Lukemire
Updated On  : 3/8/2018
Description : Modified section for inspection updates to have EstimatedReconExteriorCosmetic
			  compare to the correct column in the stage table
    ...
    BEGIN;
        BEGIN TRY;
            ...
            WHERE  ( --(COALESCE(bi.ManualBookValue, 0) <> COALESCE(bi.ManualBookValue, 0) AND bi.ManualBookValue = 0)
                       ...
                       OR COALESCE(bi.EstimatedReconExteriorCosmetic, 0) <> COALESCE(bs.EstimatedReconExteriorCosmetic, 0)
