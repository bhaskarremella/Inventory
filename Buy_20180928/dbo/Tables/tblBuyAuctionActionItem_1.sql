...
GO
CREATE NONCLUSTERED INDEX [idx_tblBuyAuctionActionItem_BuyAuctionActionItemTypeID]
    ON [dbo].[tblBuyAuctionActionItem]([BuyAuctionActionItemTypeID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [idx_tblBuyAuctionActionItem_BuyAuctionVehicleID]
    ON [dbo].[tblBuyAuctionActionItem]([BuyAuctionVehicleID] ASC) WITH (FILLFACTOR = 90);
